...
/// <summary>
///     This script can be used to stretch objects relative to the screen's width and height. The most obvious use
///     would be to create a full-screen background by attaching it to a sprite.
/// </summary>
[ExecuteInEditMode]
...
public class UIStretch : MonoBehaviour {
	...
	/// <summary>
	///     Whether the operation will occur only once and the script will then be disabled. Screen size changes will
	///     still cause the script's logic to execute.
	/// </summary>
	public bool runOnlyOnce = true;

	/// <summary>Relative-to-target size.</summary>
	public Vector2 relativeSize = Vector2.one;

	/// <summary>
	///     The size that the item/image should start out initially. Used for FillKeepingRatio, and
	///     FitInternalKeepingRatio. Contributed by Dylan Ryan.
	/// </summary>
	public Vector2 initialSize = Vector2.one;

	/// <summary>Padding applied after the size of the stretched object gets calculated. This value is in pixels.</summary>
