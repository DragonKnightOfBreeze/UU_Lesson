...
/// <summary>
///     UI Panel is responsible for collecting, sorting and updating widgets in addition to generating widgets'
///     geometry.
/// </summary>
[ExecuteInEditMode]
[AddComponentMenu("NGUI/UI/NGUI Panel")]
public class UIPanel : UIRect {
	/// <summary>List of active panels.</summary>
	...
	/// <summary>Notification triggered when the panel's geometry get rebuilt. It's mainly here for debugging purposes.</summary>
	public OnGeometryUpdated onGeometryUpdated;

	/// <summary>
	///     Whether this panel will show up in the panel tool (set this to 'false' for dynamically created temporary
	///     panels)
	/// </summary>
	public bool showInPanelTool = true;

	/// <summary>Whether normals and tangents will be generated for all meshes.</summary>
	public bool generateNormals;

	/// <summary>Whether secondary UV coordinates will be generated for all meshes.</summary>
	public bool generateUV2;

#if !UNITY_4_7
	/// <summary>Whether generated geometry will cast shadows.</summary>
	public UIDrawCall.ShadowMode shadowMode = UIDrawCall.ShadowMode.None;
#endif

	/// <summary>Whether widgets drawn by this panel are static (won't move). This will improve performance.</summary>
	public bool widgetsAreStatic;

	/// <summary>
	///     Whether widgets will be culled while the panel is being dragged. Having this on improves performance, but
	///     turning it off will reduce garbage collection.
	/// </summary>
	public bool cullWhileDragging = true;

	/// <summary>
	///     Optimization flag. Makes the assumption that the panel's geometry will always be on screen and the bounds
	///     don't need to be re-calculated.
	/// </summary>
	public bool alwaysOnScreen;

	/// <summary>
	///     By default, non-clipped panels use the camera's bounds, and the panel's position has no effect. If you want
	///     the panel's position to actually be used with anchors, set this field to 'true'.
	/// </summary>
	public bool anchorOffset;

	/// <summary>Whether the soft border will be used as padding.</summary>
	public bool softBorderPadding = true;

	/// <summary>
	///     By default all panels manage render queues of their draw calls themselves by incrementing them so that the
	///     geometry is drawn in the proper order. You can alter this behaviour.
	/// </summary>
	public RenderQueue renderQueue = RenderQueue.Automatic;

	/// <summary>
	///     Render queue used by the panel. The default value of '3000' is the equivalent of "Transparent". This property
	///     is only used if 'renderQueue' is set to something other than "Automatic".
	/// </summary>
	public int startingRenderQueue = 3000;

	/// <summary>
	///     Sorting layer used by the panel -- used when mixing NGUI with the Unity's 2D system. Contributed by Benzino07:
	///     http://www.tasharen.com/forum/index.php?topic=6956.15
	/// </summary>
	...
	/// <summary>List of widgets managed by this panel. Do not attempt to modify this list yourself.</summary>
	[System.NonSerialized]
	public List<UIWidget> widgets = new List<UIWidget>();

	/// <summary>List of draw calls created by this panel. Do not attempt to modify this list yourself.</summary>
	[System.NonSerialized]
	public List<UIDrawCall> drawCalls = new List<UIDrawCall>();

	/// <summary>Matrix that will transform the specified world coordinates to relative-to-panel coordinates.</summary>
	[System.NonSerialized]
	public Matrix4x4 worldToLocal = Matrix4x4.identity;

	/// <summary>Cached clip range passed to the draw call's shader.</summary>
	[System.NonSerialized]
	public Vector4 drawCallClipRange = new Vector4(0f, 0f, 1f, 1f);

	public delegate void OnClippingMoved(UIPanel panel);

	/// <summary>Event callback that's triggered when the panel's clip region gets moved.</summary>
	public OnClippingMoved onClipMove;

	/// <summary>
	///     There may be cases where you will want to create a custom material per-widget in order to have unique draw
	///     calls. If that's the case, set this delegate and return your newly created material. Note that it's up to you to
	///     cache this material for the next call.
	/// </summary>
	public OnCreateMaterial onCreateMaterial;

	public delegate Material OnCreateMaterial(UIWidget widget, Material mat);

	/// <summary>Event callback that's triggered whenever the panel creates a new draw call.</summary>
	...
	/// <summary>Helper property that returns the first unused depth value.</summary>
	...
	/// <summary>Whether the rectangle can be anchored.</summary>

	public override bool canBeAnchored => mClipping != UIDrawCall.Clipping.None;

	/// <summary>Panel's alpha affects everything drawn by the panel.</summary>
	...
	/// <summary>Panels can have their own depth value that will change the order with which everything they manage gets drawn.</summary>
	...
	/// <summary>Whether sorting order will be used or not. Sorting order is used with Unity's 2D system.</summary>
	public bool useSortingOrder;
	private Vector3[] _localCorners;
	private Vector3[] _worldCorners;

	/// <summary>Sorting order value for the panel's draw calls, to be used with Unity's 2D system.</summary>
	...
	/// <summary>Function that can be used to depth-sort panels.</summary>
	...
	/// <summary>Panel's width in pixels.</summary>

	public float width => GetViewSize().x;

	/// <summary>Panel's height in pixels.</summary>

	public float height => GetViewSize().y;

	/// <summary>Whether the panel's drawn geometry needs to be offset by a half-pixel.</summary>
	...
	/// <summary>Whether the camera is used to draw UI geometry.</summary>

#if UNITY_4_3 || UNITY_4_5 || UNITY_4_6 || UNITY_4_7
	public bool usedForUI { get { return (anchorCamera != null && mCam.isOrthoGraphic); } }
#else
	public bool usedForUI {
		get { return anchorCamera != null && mCam.orthographic; }
	}
#endif

	/// <summary>Directx9 pixel offset, used for drawing.</summary>
	...
	public Vector3 drawCallOffset {
		get {
...
#endif 
			{
				...
				var pixelSize = root != null ? root.pixelSizeAdjustment : 1f;
				var mod = pixelSize / size.y / mCam.orthographicSize;
	...
	/// <summary>Clipping method used by all draw calls.</summary>
	...
	/// <summary>Reference to the parent panel, if any.</summary>

	public UIPanel parentPanel => mParentPanel;

	/// <summary>Number of times the panel's contents get clipped.</summary>
	...
	/// <summary>Whether the panel will actually perform clipping of children.</summary>
	...
	/// <summary>
	///     Clipping area offset used to make it possible to move clipped panels (scroll views) efficiently. Scroll views
	///     move by adjusting the clip offset by one value, and the transform position by the inverse. This makes it possible
	///     to not have to rebuild the geometry, greatly improving performance.
	/// </summary>

	public Vector2 clipOffset {
		get { return mClipOffset; }
		set {
	...
	/// <summary>Invalidate the panel's clipping, calling child panels in turn.</summary>
	...
	/// <summary>Texture used to clip the region.</summary>

	public Texture2D clipTexture {
		get { return mClipTexture; }
		set {
	...
	/// <summary>
	///     Clipping position (XY) and size (ZW). Note that you should not be modifying this property at run-time to
	///     reposition the clipping. Adjust clipOffset instead.
	/// </summary>
		...
		set {
			if(Mathf.Abs(mClipRange.x - value.x) > 0.001f ||
			   ...
			   Mathf.Abs(mClipRange.w - value.w) > 0.001f) {
				...
				var sv = GetComponent<UIScrollView>();
	...
	/// <summary>Final clipping region after the offset has been taken into consideration. XY = center, ZW = size.</summary>
	...
	/// <summary>Clipping softness is used if the clipped style is set to "Soft".</summary>
	...
	private static readonly Vector3[] mCorners = new Vector3[4];

	/// <summary>
	///     Local-space corners of the panel's clipping rectangle. The order is bottom-left, top-left, top-right,
	///     bottom-right.
	/// </summary>
	...
	public override Vector3[] localCorners {
		get {
			if(mClipping == UIDrawCall.Clipping.None) {
				...
				for(var i = 0; i < 4; ++i) corners[i] = wt.InverseTransformPoint(corners[i]);
				return corners;
			}
			var x0 = mClipOffset.x + mClipRange.x - 0.5f * mClipRange.z;
			var y0 = mClipOffset.y + mClipRange.y - 0.5f * mClipRange.w;
			var x1 = x0 + mClipRange.z;
			var y1 = y0 + mClipRange.w;
	...
	/// <summary>
	///     World-space corners of the panel's clipping rectangle. The order is bottom-left, top-left, top-right,
	///     bottom-right.
	/// </summary>
	...
	public override Vector3[] worldCorners {
		get {
			if(mClipping != UIDrawCall.Clipping.None) {
				...
				var corners = mCam.GetWorldCorners(cameraRayDistance);
				...
				if(anchorOffset && (mCam == null || mCam.transform.parent != cachedTransform)) {
					var off = cachedTransform.position;
					for(var i = 0; i < 4; ++i)
						mCorners[i] += off;
				}
			}
	...
	/// <summary>Get the sides of the rectangle relative to the specified transform. The order is left, top, right, bottom.</summary>
	public override Vector3[] GetSides(Transform relativeTo) {
		...
		if(anchorCamera != null && anchorOffset) {
			var sides = mCam.GetSides(cameraRayDistance);
			var off = cachedTransform.position;
			for(var i = 0; i < 4; ++i)
				sides[i] += off;
	...
	/// <summary>Invalidating the panel should reset its alpha.</summary>
	public override void Invalidate(bool includeChildren) {
		mAlphaFrameID = -1;
		base.Invalidate(includeChildren);
	}

	/// <summary>Widget's final alpha, after taking the panel's alpha into account.</summary>
	...
	/// <summary>Set the panel's rectangle.</summary>
	...
	/// <summary>Returns whether the specified rectangle is visible by the panel. The coordinates must be in world space.</summary>
#if UNITY_FLASH
...
// http://www.tasharen.com/forum/index.php?topic=11390.0
		...
		var minX = Mathf.Min(mTemp);
		var maxX = Mathf.Max(mTemp);
		...
		var minY = Mathf.Min(mTemp);
		var maxY = Mathf.Max(mTemp);
	...
	/// <summary>Returns whether the specified world position is within the panel's bounds determined by the clipping rect.</summary>
	...
	/// <summary>Returns whether the specified widget is visible by the panel.</summary>
	...
	/// <summary>Whether the specified widget is going to be affected by this panel in any way.</summary>
	public bool Affects(UIWidget w) {
		if(w == null) return false;

		var expected = w.panel;
	...
	/// <summary>Causes all draw calls to be re-created on the next update.</summary>
	...
	/// <summary>
	///     Invalidate the panel's draw calls, forcing them to be rebuilt on the next update. This call also affects all
	///     children.
	/// </summary>
	...
	/// <summary>Find the parent panel, if we have one.</summary>
	...
	/// <summary>Layer is used to ensure that if it changes, widgets get moved as well.</summary>
	protected override void OnStart() {
		mLayer = cachedGameObject.layer;
	}

	/// <summary>Reset the frame IDs.</summary>
	...
	/// <summary>Mark all widgets as having been changed so the draw calls get re-created.</summary>
	...
	/// <summary>Destroy all draw calls we've created when this script gets disabled.</summary>
	...
	/// <summary>Update the world-to-local transform matrix as well as clipping bounds.</summary>
	private void UpdateTransformMatrix() {
		...
		if(mHasMoved || mMatrixFrame != fc) {
			...
			var size = GetViewSize() * 0.5f;

			var x = mClipOffset.x + mClipRange.x;
			var y = mClipOffset.y + mClipRange.y;
	...
	/// <summary>Update the edges after the anchors have been updated.</summary>
	protected override void OnAnchor() {
		...
		var newX = Mathf.Lerp(lt, rt, 0.5f);
		var newY = Mathf.Lerp(bt, tt, 0.5f);
		var w = rt - lt;
		var h = tt - bt;

		var minx = Mathf.Max(2f, mClipSoftness.x);
		var miny = Mathf.Max(2f, mClipSoftness.y);
	...
	/// <summary>Update all panels and draw calls.</summary>
	...
	/// <summary>Update the panel, all of its widgets and draw calls.</summary>
	...
	/// <summary>Immediately sort all child widgets.</summary>
	public void SortWidgets() {
		mSortWidgets = false;
		widgets.Sort(UIWidget.PanelCompareFunc);
	}

	/// <summary>Fill the geometry fully, processing all widgets and re-creating all draw calls.</summary>
	...
	/// <summary>Fill the geometry for the specified draw call.</summary>
	public bool FillDrawCall(UIDrawCall dc) {
		if(dc != null) {
			dc.isDirty = false;
			var count = 0;

			for(var i = 0; i < widgets.Count;) {
				var w = widgets[i];
	...
	/// <summary>Update all draw calls associated with the panel.</summary>
	...
	/// <summary>Update the widget layers if the panel's layer has changed.</summary>
	...
	/// <summary>Update all of the widgets belonging to this panel.</summary>
	private void UpdateWidgets() {
		var changed = false;
		var forceVisible = false;
		var clipped = hasCumulativeClipping;
			...
			if(w.panel == this && w.enabled) {
				...
				if(!Application.isPlaying) {
					...
					if(t.hideFlags != HideFlags.HideInHierarchy)
						t = t.parent != null && t.parent.hideFlags == HideFlags.HideInHierarchy ? t.parent : null;
	...
	/// <summary>
	///     Insert the specified widget into one of the existing draw calls if possible. If it's not possible, and a new
	///     draw call is required, 'null' is returned because draw call creation is a delayed operation.
	/// </summary>
	public UIDrawCall FindDrawCall(UIWidget w) {
		...
		for(var i = 0; i < drawCalls.Count; ++i) {
			var dc = drawCalls[i];
			var dcStart = i == 0 ? int.MinValue : drawCalls[i - 1].depthEnd + 1;
			var dcEnd = i + 1 == drawCalls.Count ? int.MaxValue : drawCalls[i + 1].depthStart - 1;
	...
	/// <summary>Make the following widget be managed by the panel.</summary>
	...
	/// <summary>Remove the widget from its current draw call, invalidating everything as needed.</summary>
	...
	/// <summary>Immediately refresh the panel.</summary>
	public void Refresh() {
		mRebuild = true;
		mUpdateFrame = -1;
	...
	/// <summary>Calculate the offset needed to be constrained within the panel's bounds.</summary>
	public virtual Vector3 CalculateConstrainOffset(Vector2 min, Vector2 max) {
		var cr = finalClipRegion;

		var offsetX = cr.z * 0.5f;
		var offsetY = cr.w * 0.5f;

		var minRect = new Vector2(min.x, min.y);
		var maxRect = new Vector2(max.x, max.y);
		var minArea = new Vector2(cr.x - offsetX, cr.y - offsetY);
		var maxArea = new Vector2(cr.x + offsetX, cr.y + offsetY);
	...
	/// <summary>Constrain the current target position to be within panel bounds.</summary>
	public bool ConstrainTargetToBounds(Transform target, ref Bounds targetBounds, bool immediate) {
		var min = targetBounds.min;
		var max = targetBounds.max;
		...
		var offset = CalculateConstrainOffset(min, max) * ps;
		...
		if(offset.sqrMagnitude > 0f) {
			if(immediate) {
				...
				var sp = SpringPosition.Begin(target.gameObject, target.localPosition + offset, 13f);
	...
	/// <summary>Constrain the specified target to be within the panel's bounds.</summary>
	public bool ConstrainTargetToBounds(Transform target, bool immediate) {
		var bounds = NGUIMath.CalculateRelativeWidgetBounds(cachedTransform, target);
		return ConstrainTargetToBounds(target, ref bounds, immediate);
	}

	/// <summary>Find the UIPanel responsible for handling the specified transform.</summary>
	...
	/// <summary>Panel's size -- which is either the clipping rect, or the screen dimensions.</summary>
...
#if UNITY_EDITOR
	/// <summary>Draw a visible pink outline for the clipped area.</summary>
	private void OnDrawGizmos() {
		if(anchorCamera == null) return;

		var clip = mClipping != UIDrawCall.Clipping.None;
		var t = clip ? transform : mCam.transform;

		var corners = worldCorners;
		for(var i = 0; i < 4; ++i) corners[i] = t.InverseTransformPoint(corners[i]);
		var pos = Vector3.Lerp(corners[0], corners[2], 0.5f);
		var size = corners[2] - corners[0];

		var go = UnityEditor.Selection.activeGameObject;
		var isUsingThisPanel = go != null && NGUITools.FindInParents<UIPanel>(go) == this;
		var isSelected = UnityEditor.Selection.activeGameObject == gameObject;
		var detailedView = isSelected && isUsingThisPanel;
		var detailedClipped = detailedView && mClipping == UIDrawCall.Clipping.SoftClip;
...
#endif 
		{
			...
			if(rt != null && rt.scalingStyle != UIRoot.Scaling.Flexible) {
				...
				var szPos = Vector3.Lerp(corners[0], corners[2], 0.5f);
				var szSize = corners[2] - corners[0];
