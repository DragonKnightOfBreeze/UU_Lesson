...
public class UILabel : UIWidget {
	...
	/// <summary>
	///     Whether the label will keep its content crisp even when shrunk. You may want to turn this off on mobile
	///     devices.
	/// </summary>
	...
	[HideInInspector]
	[SerializeField]
	private Alignment mAlignment = Alignment.Automatic;
	[HideInInspector]
	[SerializeField]
	private bool mEncoding = true;
	[HideInInspector]
	[SerializeField]
	private int mMaxLineCount; // 0 denotes unlimited
	[HideInInspector]
	[SerializeField]
	...
	[HideInInspector]
	[SerializeField]
	private Modifier mModifier = Modifier.None;
	...
	/// <summary>Font size after modifications got taken into consideration such as shrinking content.</summary>
	...
	/// <summary>Function used to determine if something has changed (and thus the geometry must be rebuilt)</summary>

	private bool shouldBeProcessed {
		get { return mShouldBeProcessed; }
		set {
			if(value) {
				mChanged = true;
	...
	/// <summary>Whether the rectangle is anchored horizontally.</summary>

	public override bool isAnchoredHorizontally => base.isAnchoredHorizontally || mOverflow == Overflow.ResizeFreely;

	/// <summary>Whether the rectangle is anchored vertically.</summary>

	public override bool isAnchoredVertically => base.isAnchoredVertically ||
	                                             mOverflow == Overflow.ResizeFreely ||
	                                             mOverflow == Overflow.ResizeHeight;

	/// <summary>Retrieve the material used by the font.</summary>
	...
	/// <summary>Label's main texture comes from the font itself.</summary>

	public override Texture mainTexture {
		get {
			if(mFont != null) return mFont.texture;
			if(mTrueTypeFont != null) {
				var mat = mTrueTypeFont.material;
				if(mat != null) return mat.mainTexture;
			}
			return null;
		}
	...
	/// <summary>Set the font used by this label.</summary>
	...
	/// <summary>Ambiguous helper function.</summary>

	public UnityEngine.Object ambigiousFont {
		get { return mFont ?? (UnityEngine.Object) mTrueTypeFont; }
		set {
			var bf = value as UIFont;
			if(bf != null) bitmapFont = bf;
			else trueTypeFont = value as Font;
		}
	}

	/// <summary>Text that's being displayed by the label.</summary>
	...
	public int defaultFontSize => trueTypeFont != null ? mFontSize : mFont != null ? mFont.defaultSize : 16;

	/// <summary>Active font size used by the label.</summary>
	...
	/// <summary>Dynamic font style used by the label.</summary>
	...
	/// <summary>Text alignment option.</summary>
	...
	/// <summary>Additional horizontal spacing between characters when printing text.</summary>
	...
	/// <summary>Additional vertical spacing between lines when printing text.</summary>
	...
	/// <summary>Whether this label will use float text spacing values, instead of integers.</summary>

	public bool useFloatSpacing {
		get { return mUseFloatSpacing; }
		set {
	...
	/// <summary>
	///     Additional horizontal spacing between characters when printing text. For this to have any effect
	///     useFloatSpacing must be true.
	/// </summary>

	public float floatSpacingX {
		get { return mFloatSpacingX; }
		set {
	...
	/// <summary>
	///     Additional vertical spacing between lines when printing text. For this to have any effect useFloatSpacing must
	///     be true.
	/// </summary>

	public float floatSpacingY {
		get { return mFloatSpacingY; }
		set {
	...
	/// <summary>Convenience property to get the used y spacing.</summary>

	public float effectiveSpacingY => mUseFloatSpacing ? mFloatSpacingY : mSpacingY;

	/// <summary>Convenience property to get the used x spacing.</summary>

	public float effectiveSpacingX => mUseFloatSpacing ? mFloatSpacingX : mSpacingX;

	/// <summary>Whether to append "..." at the end of clamped text that didn't fit.</summary>

	public bool overflowEllipsis {
		get { return mOverflowEllipsis; }
		set {
	...
	/// <summary>
	///     Maximum width used when Resize Freely overflow type is enabled. If the printed text exceeds this width, it
	///     will wrap onto the following line.
	/// </summary>

	public int overflowWidth {
		get { return mOverflowWidth; }
		set {
	...
	/// <summary>
	///     Whether the label will use the printed size instead of font size when printing the label. It's a dynamic font
	///     feature that will ensure that the text is crisp when shrunk.
	/// </summary>
	...
	/// <summary>Style used for symbols.</summary>
	...
	/// <summary>Overflow method controls the label's behaviour when its content doesn't fit the bounds.</summary>

	public Overflow overflowMethod {
		get { return mOverflow; }
		set {
			if(mOverflow != value) {
				mOverflow = value;
				shouldBeProcessed = true;
	...
	/// <summary>Maximum width of the label in pixels.</summary>
	...
	/// <summary>Maximum height of the label in pixels.</summary>
	...
	/// <summary>Whether the label supports multiple lines.</summary>
	...
	/// <summary>Process the label's text before returning its corners.</summary>
	...
	/// <summary>Process the label's text before returning its drawing dimensions.</summary>
	...
	/// <summary>The max number of lines to be displayed for the label</summary>
	...
	/// <summary>What effect is used by the label.</summary>
	...
	/// <summary>Color used by the effect, if it's enabled.</summary>
	...
	/// <summary>Effect distance in pixels.</summary>
	...
	/// <summary>How many quads there are per printed character.</summary>

	public int quadsPerCharacter {
		get {
			if(mEffectStyle == Effect.Shadow) return 2;
			if(mEffectStyle == Effect.Outline) return 5;
			if(mEffectStyle == Effect.Outline8) return 9;
			return 1;
		}
	}

	/// <summary>Whether the label will automatically shrink its size in order to fit the maximum line width.</summary>

	[Obsolete("Use 'overflowMethod == UILabel.Overflow.ShrinkContent' instead")]
	public bool shrinkToFit {
		get { return mOverflow == Overflow.ShrinkContent; }
		set {
			if(value)
	...
	/// <summary>Returns the processed version of 'text', with new line characters, line wrapping, etc.</summary>
	...
	/// <summary>Actual printed size of the text, in pixels.</summary>
	...
	/// <summary>Local size of the widget, in pixels.</summary>
	...
	/// <summary>Whether the label has a valid font.</summary>

	private bool isValid => mFont != null || mTrueTypeFont != null;

	/// <summary>Custom text modifier that can transform the visible text when the label's text is assigned.</summary>
	public ModifierFunc customModifier;

	public delegate string ModifierFunc(string s);

	/// <summary>Text modifier can transform the text that's actually printed, without altering the label's text value.</summary>
	...
	private static readonly BetterList<UILabel> mList = new BetterList<UILabel>();
	private static readonly Dictionary<Font, int> mFontUsage = new Dictionary<Font, int>();

	/// <summary>Register the font texture change listener.</summary>
	...
	/// <summary>Remove the font texture change listener.</summary>
	...
	/// <summary>Set the active font, correctly setting and clearing callbacks.</summary>
	...
	/// <summary>Label's actual printed text may be modified before being drawn.</summary>
	...
	/// <summary>
	///     Notification called when the Unity's font's texture gets rebuilt. Unity's font has a nice tendency to simply
	///     discard other characters when the texture's dimensions change. By requesting them inside the notification callback,
	///     we immediately force them back in. Originally I was subscribing each label to the font individually, but as it
	///     turned out mono's delegate system causes an insane amount of memory allocations when += or -= to a delegate. So...
	///     queue yet another work-around.
	/// </summary>
	...
	/// <summary>Upgrading labels is a bit different.</summary>
	...
	/// <summary>If the label is anchored it should not auto-resize.</summary>
	...
	/// <summary>Request the needed characters in the texture.</summary>
	...
	[NonSerialized]
	private bool mAllowProcessing = true;
	[NonSerialized]
	private bool mUsingTTF = true;

	/// <summary>Validate the properties.</summary>
	...
	/// <summary>Determine start-up values.</summary>
	...
	/// <summary>UILabel needs additional processing when something changes.</summary>
	public override void MarkAsChanged() {
		shouldBeProcessed = true;
		base.MarkAsChanged();
	}

	/// <summary>Process the raw text, called when something changes.</summary>
	public void ProcessText(bool legacyMode = false, bool full = true) {
		...
		var regionX = mDrawRegion.z - mDrawRegion.x;
		var regionY = mDrawRegion.w - mDrawRegion.y;
		...
		var isDynamic = trueTypeFont != null;
		...
		if(mFinalFontSize > 0) {
			var adjustSize = keepCrisp;

			for(var ps = mFinalFontSize; ps > 0; --ps) {
				...
				if(mOverflow == Overflow.ResizeFreely) {
					...
					var w = Mathf.Max(minWidth, Mathf.RoundToInt(mCalculatedSize.x));
					if(regionX != 1f) w = Mathf.RoundToInt(w / regionX);
					var h = Mathf.Max(minHeight, Mathf.RoundToInt(mCalculatedSize.y));
	...
	/// <summary>Text is pixel-perfect when its scale matches the size.</summary>
	public override void MakePixelPerfect() {
		if(ambigiousFont != null) {
			var pos = cachedTransform.localPosition;
			...
			if(mOverflow == Overflow.ResizeFreely) {
				...
				var minX = Mathf.RoundToInt(mCalculatedSize.x);
				var minY = Mathf.RoundToInt(mCalculatedSize.y);
	...
	/// <summary>Make the label assume its natural size.</summary>
	...
	private static readonly List<Vector3> mTempVerts = new List<Vector3>();
	private static readonly List<int> mTempIndices = new List<int>();

	/// <summary>Return the index of the character at the specified world position.</summary>
	...
	/// <summary>Return the index of the character at the specified local position.</summary>
	public int GetCharacterIndexAtPosition(Vector2 localPos, bool precise) {
		if(isValid) {
			...
			if(mTempVerts.Count > 0) {
				...
				var retVal = precise ? NGUIText.GetExactCharacterIndex(mTempVerts, mTempIndices, localPos) : NGUIText.GetApproximateCharacterIndex(mTempVerts, mTempIndices, localPos);
	...
	/// <summary>Retrieve the word directly below the specified world-space position.</summary>
	public string GetWordAtPosition(Vector3 worldPos) {
		var index = GetCharacterIndexAtPosition(worldPos, true);
		return GetWordAtCharacterIndex(index);
	}

	/// <summary>Retrieve the word directly below the specified relative-to-label position.</summary>
	public string GetWordAtPosition(Vector2 localPos) {
		var index = GetCharacterIndexAtPosition(localPos, true);
		return GetWordAtCharacterIndex(index);
	}

	/// <summary>Retrieve the word right under the specified character index.</summary>
...
#else
			var wordStart = s.LastIndexOfAny(new[] {' ', '\n'}, characterIndex) + 1;
			var wordEnd = s.IndexOfAny(new[] {' ', '\n', ',', '.'}, characterIndex);
#endif
			if(wordEnd == -1) wordEnd = s.Length;

			if(wordStart != wordEnd) {
				var len = wordEnd - wordStart;

				if(len > 0) {
					var word = s.Substring(wordStart, len);
...
/// </summary>
	...
	/// <summary>Retrieve the URL directly below the specified world-space position.</summary>
	public string GetUrlAtPosition(Vector3 worldPos) {
		return GetUrlAtCharacterIndex(GetCharacterIndexAtPosition(worldPos, true));
	}

	/// <summary>Retrieve the URL directly below the specified relative-to-label position.</summary>
	public string GetUrlAtPosition(Vector2 localPos) {
		return GetUrlAtCharacterIndex(GetCharacterIndexAtPosition(localPos, true));
	}

	/// <summary>Retrieve the URL right under the specified character index.</summary>
	public string GetUrlAtCharacterIndex(int characterIndex) {
		...
		if(characterIndex != -1 && characterIndex < s.Length - 6) {
			...
			var urlEnd = s.IndexOf("[/url]", linkEnd);
	...
	/// <summary>Get the index of the character on the line directly above or below the current index.</summary>
	public int GetCharacterIndex(int currentIndex, KeyCode key) {
		if(isValid) {
			var text = processedText;
			if(string.IsNullOrEmpty(text)) return 0;

			var def = defaultFontSize;
			UpdateNGUIText();
			...
			if(mTempVerts.Count > 0) {
				...
				for(int i = 0, imax = mTempIndices.Count; i < imax; ++i)
					if(mTempIndices[i] == currentIndex) {
						...
						var retVal = NGUIText.GetApproximateCharacterIndex(mTempVerts, mTempIndices, localPos);
	...
	/// <summary>Fill the specified geometry buffer with vertices that would highlight the current selection.</summary>
	public void PrintOverlay(int start, int end, UIGeometry caret, UIGeometry highlight, Color caretColor, Color highlightColor) {
		...
		var startingCaretVerts = caret.verts.Count;
		var center = new Vector2(0.5f, 0.5f);
		var alpha = finalAlpha;

		// If we have a highlight to work with, fill the buffer
		if(highlight != null && start != end) {
			var startingVertices = highlight.verts.Count;
			...
			if(highlight.verts.Count > startingVertices) {
				...
				var c = new Color(highlightColor.r, highlightColor.g, highlightColor.b, highlightColor.a * alpha);
		...
		var cc = new Color(caretColor.r, caretColor.g, caretColor.b, caretColor.a * alpha);
	...
	/// <summary>Draw the label.</summary>
	...
	/// <summary>
	///     Align the vertices, making the label positioned correctly based on the pivot. Returns the offset that was
	///     applied.
	/// </summary>
	public Vector2 ApplyOffset(List<Vector3> verts, int start) {
		var po = pivotOffset;

		var fx = Mathf.Lerp(0f, -mWidth, po.x);
		var fy = Mathf.Lerp(mHeight, 0f, po.y) + Mathf.Lerp(mCalculatedSize.y - mHeight, 0f, po.y);
	...
	/// <summary>Apply a shadow effect to the buffer.</summary>
	...
	/// <summary>Calculate the character index offset necessary in order to print the end of the specified text.</summary>
	public int CalculateOffsetToFit(string text) {
		UpdateNGUIText();
		NGUIText.encoding = false;
		NGUIText.symbolStyle = NGUIText.SymbolStyle.None;
		var offset = NGUIText.CalculateOffsetToFit(text);
		NGUIText.bitmapFont = null;
		NGUIText.dynamicFont = null;
		return offset;
	}
	...
	/// <summary>
	///     Convenience function, in case you wanted to associate progress bar, slider or scroll bar's OnValueChanged
	///     function in inspector with a label.
	/// </summary>
	...
	/// <summary>
	///     Convenience function, in case you wanted to automatically set some label's text by selecting a value in the
	///     UIPopupList.
	/// </summary>
	...
	/// <summary>Convenience function -- wrap the current text given the label's settings and unlimited height.</summary>
	public bool Wrap(string text, out string final) {
		return Wrap(text, out final, 1000000);
	}

	/// <summary>Convenience function -- wrap the current text given the label's settings and the given height.</summary>
	public bool Wrap(string text, out string final, int height) {
		UpdateNGUIText();
		NGUIText.rectHeight = height;
		NGUIText.regionHeight = height;
		var retVal = NGUIText.WrapText(text, out final);
		NGUIText.bitmapFont = null;
		NGUIText.dynamicFont = null;
		return retVal;
	}

	/// <summary>Update NGUIText.current with all the properties from this label.</summary>
	public void UpdateNGUIText() {
		...
		if(mFont != null) {
			...
			for(;;) {
				var fnt = NGUIText.bitmapFont.replacement;
				if(fnt == null) break;
