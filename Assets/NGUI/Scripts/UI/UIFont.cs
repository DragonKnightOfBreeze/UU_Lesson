...
/// <summary>UIFont contains everything needed to be able to print text.</summary>
[ExecuteInEditMode]
...
public class UIFont : MonoBehaviour {
	...
	[HideInInspector]
	[SerializeField]
	private FontStyle mDynamicFontStyle = FontStyle.Normal;
	...
	/// <summary>Access to the BMFont class directly.</summary>

	public BMFont bmFont {
		get { return mReplacement != null ? mReplacement.bmFont : mFont; }
		set {
	...
	/// <summary>Original width of the font's texture in pixels.</summary>

	public int texWidth {
		get { return mReplacement != null ? mReplacement.texWidth : mFont != null ? mFont.texWidth : 1; }
		set {
	...
	/// <summary>Original height of the font's texture in pixels.</summary>

	public int texHeight {
		get { return mReplacement != null ? mReplacement.texHeight : mFont != null ? mFont.texHeight : 1; }
		set {
	...
	/// <summary>Whether the font has any symbols defined.</summary>

	public bool hasSymbols => mReplacement != null ? mReplacement.hasSymbols : mSymbols != null && mSymbols.Count != 0;

	/// <summary>List of symbols within the font.</summary>

	public List<BMSymbol> symbols => mReplacement != null ? mReplacement.symbols : mSymbols;

	/// <summary>Atlas used by the font, if any.</summary>

	public UIAtlas atlas {
		get { return mReplacement != null ? mReplacement.atlas : mAtlas; }
		set {
	...
	/// <summary>Get or set the material used by this font.</summary>
	...
	/// <summary>Whether the font is using a premultiplied alpha material.</summary>
	...
	/// <summary>Whether the font is a packed font.</summary>
	...
	/// <summary>Convenience function that returns the texture used by the font.</summary>
	...
	/// <summary>Offset and scale applied to all UV coordinates.</summary>
	...
	/// <summary>Sprite used by the font, if any.</summary>

	public string spriteName {
		get { return mReplacement != null ? mReplacement.spriteName : mFont.spriteName; }
		set {
			if(mReplacement != null) {
	...
	/// <summary>Whether this is a valid font.</summary>
	...
	/// <summary>Pixel-perfect size of this font.</summary>
	...
	/// <summary>Retrieves the sprite used by the font, if any.</summary>
	...
	/// <summary>Whether the font is dynamic.</summary>

	public bool isDynamic => mReplacement != null ? mReplacement.isDynamic : mDynamicFont != null;

	/// <summary>Get or set the dynamic font source.</summary>

	public Font dynamicFont {
		get { return mReplacement != null ? mReplacement.dynamicFont : mDynamicFont; }
		set {
			if(mReplacement != null) {
	...
	/// <summary>Get or set the dynamic font's style.</summary>

	public FontStyle dynamicFontStyle {
		get { return mReplacement != null ? mReplacement.dynamicFontStyle : mDynamicFontStyle; }
		set {
			if(mReplacement != null) {
	...
	/// <summary>Trim the glyphs, making sure they never go past the trimmed texture bounds.</summary>
	private void Trim() {
		var tex = mAtlas.texture;

		if(tex != null && mSprite != null) {
			var full = NGUIMath.ConvertToPixels(mUVRect, texture.width, texture.height, true);
			var trimmed = new Rect(mSprite.x, mSprite.y, mSprite.width, mSprite.height);
	...
	/// <summary>Helper function that determines whether the font uses the specified one, taking replacements into account.</summary>
	...
	/// <summary>Helper function that determines whether the two atlases are related.</summary>
	...
	/// <summary>Refresh all labels that use this font.</summary>
	...
	/// <summary>Forcefully update the font's sprite reference.</summary>
	public void UpdateUVRect() {
		...
		if(tex != null) {
			...
			if(mFont != null) {
				var tw = (float) mFont.texWidth / tex.width;
				var th = (float) mFont.texHeight / tex.height;
	...
	/// <summary>Retrieve the specified symbol, optionally creating it if it's missing.</summary>
	...
	/// <summary>Retrieve the symbol at the beginning of the specified sequence, if a match is found.</summary>
	...
	/// <summary>Add a new symbol to the font.</summary>
	...
	/// <summary>Remove the specified symbol from the font.</summary>
	...
	/// <summary>Change an existing symbol's sequence to the specified value.</summary>
	...
	/// <summary>Whether the specified sprite is being used by the font.</summary>
