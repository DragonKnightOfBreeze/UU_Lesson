...
/// <summary>Simple example script of how a button can be rotated visibly when the mouse hovers over it or it gets pressed.</summary>
...
public class UIButtonRotation : MonoBehaviour {
	...
	private void OnDisable() {
		if(mStarted && tweenTarget != null) {
			var tc = tweenTarget.GetComponent<TweenRotation>();
