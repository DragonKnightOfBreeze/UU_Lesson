...
/// <summary>Play the specified tween on click.</summary>
[ExecuteInEditMode]
[AddComponentMenu("NGUI/Interaction/Play Tween")]
public class UIPlayTween : MonoBehaviour {
	public static UIPlayTween current;

	/// <summary>Target on which there is one or more tween.</summary>
	public GameObject tweenTarget;

	/// <summary>If there are multiple tweens, you can choose which ones get activated by changing their group.</summary>
	public int tweenGroup;

	/// <summary>Which event will trigger the tween.</summary>
	public Trigger trigger = Trigger.OnClick;

	/// <summary>Direction to tween in.</summary>
	public Direction playDirection = Direction.Forward;

	/// <summary>
	///     Whether the tween will be reset to the start or end when activated. If not, it will continue from where it
	///     currently is.
	/// </summary>
	public bool resetOnPlay;

	/// <summary>Whether the tween will be reset to the start if it's disabled when activated.</summary>
	public bool resetIfDisabled;

	/// <summary>What to do if the tweenTarget game object is currently disabled.</summary>
	public EnableCondition ifDisabledOnPlay = EnableCondition.DoNothing;

	/// <summary>What to do with the tweenTarget after the tween finishes.</summary>
	public DisableCondition disableWhenFinished = DisableCondition.DoNotDisable;

	/// <summary>Whether the tweens on the child game objects will be considered.</summary>
	...
	private void OnDragOver() {
		if(trigger == Trigger.OnHover) OnHover(true);
	}
	...
	/// <summary>Wait for the hover event to happen outside the object's hierarchy before removing the hovered state.</summary>
	...
	/// <summary>Activate the tweeners.</summary>
