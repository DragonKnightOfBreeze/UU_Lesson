...
/// <summary>
///     This script can be used to forward events from one object to another. In most cases you should use
///     UIEventListener script instead. For example: UIEventListener.Get(gameObject).onClick += MyClickFunction;
/// </summary>
