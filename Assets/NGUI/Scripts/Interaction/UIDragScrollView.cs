...
/// <summary>Allows dragging of the specified scroll view by mouse or touch.</summary>
[AddComponentMenu("NGUI/Interaction/Drag Scroll View")]
public class UIDragScrollView : MonoBehaviour {
	/// <summary>Reference to the scroll view that will be dragged by the script.</summary>
	...
	/// <summary>Automatically find the scroll view if possible.</summary>
	...
	/// <summary>Find the scroll view.</summary>
	private void Start() {
		mStarted = true;
		FindScrollView();
	}

	/// <summary>Find the scroll view to work with.</summary>
	private void FindScrollView() {
		// If the scroll view is on a parent, don't try to remember it (as we want it to be dynamic in case of re-parenting)
		var sv = NGUITools.FindInParents<UIScrollView>(mTrans);
	...
	/// <summary>Stop the active dragging operation.</summary>
