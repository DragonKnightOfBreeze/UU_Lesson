...
/// <summary>Simple toggle functionality.</summary>
[ExecuteInEditMode]
[AddComponentMenu("NGUI/Interaction/Toggle")]
public class UIToggle : UIWidgetContainer {
	/// <summary>List of all the active toggles currently in the scene.</summary>
	public static BetterList<UIToggle> list = new BetterList<UIToggle>();

	/// <summary>Current toggle that sent a state change notification.</summary>
	public static UIToggle current;

	/// <summary>If set to anything other than '0', all active toggles in this group will behave as radio buttons.</summary>
	public int group;

	/// <summary>Sprite that's visible when the 'isActive' status is 'true'.</summary>
	public UIWidget activeSprite;

	/// <summary>If 'true', when checked the sprite will be hidden when the toggle is checked instead of when it's not.</summary>
	public bool invertSpriteState;

	/// <summary>Animation to play on the active sprite, if any.</summary>
	public Animation activeAnimation;

	/// <summary>Animation to play on the active sprite, if any.</summary>
	public Animator animator;

	/// <summary>Tween to use, if any.</summary>
	public UITweener tween;

	/// <summary>Whether the toggle starts checked.</summary>
	public bool startsActive;

	/// <summary>If checked, tween-based transition will be instant instead.</summary>
	public bool instantTween;

	/// <summary>Can the radio button option be 'none'?</summary>
	public bool optionCanBeNone;

	/// <summary>Callbacks triggered when the toggle's state changes.</summary>
	public List<EventDelegate> onChange = new List<EventDelegate>();

	public delegate bool Validate(bool choice);

	/// <summary>Want to validate the choice before committing the changes? Set this delegate.</summary>
	public Validate validator;

	/// <summary>Deprecated functionality. Use the 'group' option instead.</summary>
	[HideInInspector]
	[SerializeField]
	...
	[HideInInspector]
	[SerializeField]
	private bool startsChecked; // Use 'startsActive' instead
	...
	public bool value {
		get { return mStarted ? mIsActive : startsActive; }
		set {
	...
	/// <summary>Return the first active toggle within the specified group.</summary>
	...
	/// <summary>Activate the initial state.</summary>
	public void Start() {
		if(mStarted) return;
	...
	/// <summary>Check or uncheck on click.</summary>
	private void OnClick() {
		if(enabled && isColliderEnabled && UICamera.currentTouchID != -2) value = !value;
	}

	/// <summary>
	///     Fade out or fade in the active sprite and notify the OnChange event listener. If setting the initial value,
	///     call Start() first.
	/// </summary>
		...
		if(!mStarted) {
			...
			if(animator != null) {
				...
				if(tween.tweenGroup != 0) {
					var tws = tween.GetComponentsInChildren<UITweener>(true);
