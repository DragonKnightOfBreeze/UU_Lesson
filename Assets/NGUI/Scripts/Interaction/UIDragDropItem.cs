...
/// <summary>UIDragDropItem is a base script for your own Drag & Drop operations.</summary>
...
public class UIDragDropItem : MonoBehaviour {
	...
	/// <summary>What kind of restriction is applied to the drag & drop logic before dragging is made possible.</summary>
	public Restriction restriction = Restriction.None;

	/// <summary>Whether a copy of the item will be dragged instead of the item itself.</summary>
	public bool cloneOnDrag;

	/// <summary>How long the user has to press on an item before the drag action activates.</summary>
	[HideInInspector]
	public float pressAndHoldDelay = 1f;

	/// <summary>Whether this drag and drop item can be interacted with. If not, only tooltips will work.</summary>
	...
	/// <summary>List of items that are currently being dragged.</summary>
	...
	protected virtual void OnDisable() {
		if(mDragging) StopDragging(UICamera.hoveredObject);
	}
	...
	/// <summary>Record the time the item was pressed on.</summary>
	...
	/// <summary>Start the dragging operation after the item was held for a while.</summary>
	...
	/// <summary>Start the dragging operation.</summary>
	...
	/// <summary>Called on the cloned object when it was duplicated.</summary>
	protected virtual void OnClone(GameObject original) { }

	/// <summary>Perform the dragging.</summary>
	...
	/// <summary>Notification sent when the drag event has ended.</summary>
	...
	/// <summary>Drop the dragged item.</summary>
	...
	/// <summary>Perform any logic related to starting the drag & drop operation.</summary>
	...
	/// <summary>Adjust the dragged object's position.</summary>
	protected virtual void OnDragDropMove(Vector2 delta) {
		mTrans.localPosition += mTrans.InverseTransformDirection(delta);
	}

	/// <summary>Drop the item onto the specified object.</summary>
	...
	/// <summary>Function called when the object gets reparented after the drop operation finishes.</summary>
	protected virtual void OnDragDropEnd() {
		draggedItems.Remove(this);
	}

	/// <summary>
	///     Re-enable the drag scroll view script at the end of the frame. Reason:
	///     http://www.tasharen.com/forum/index.php?topic=10203.0
	/// </summary>
	...
	/// <summary>Application losing focus should cancel the dragging operation.</summary>
	protected void OnApplicationFocus(bool focus) {
		if(!focus) StopDragging(null);
	}
}