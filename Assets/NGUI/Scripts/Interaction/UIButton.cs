...
/// <summary>Similar to UIButtonColor, but adds a 'disabled' state based on whether the collider is enabled or not.</summary>
[AddComponentMenu("NGUI/Interaction/Button")]
public class UIButton : UIButtonColor {
	/// <summary>Current button that sent out the onClick event.</summary>
	public static UIButton current;

	/// <summary>Whether the button will highlight when you drag something over it.</summary>
	public bool dragHighlight;

	/// <summary>Name of the hover state sprite.</summary>
	public string hoverSprite;

	/// <summary>Name of the pressed sprite.</summary>
	public string pressedSprite;

	/// <summary>Name of the disabled sprite.</summary>
	...
	/// <summary>Whether the sprite changes will elicit a call to MakePixelPerfect() or not.</summary>
	public bool pixelSnap;

	/// <summary>Click event listener.</summary>
	...
	/// <summary>Whether the button should be enabled.</summary>
	...
	/// <summary>Convenience function that changes the normal sprite.</summary>
	...
	/// <summary>Cache the sprite we'll be working with.</summary>
	...
	/// <summary>Drag over state logic is a bit different for the button.</summary>
	protected override void OnDragOver() {
		if(isEnabled && (dragHighlight || UICamera.currentTouch.pressed == gameObject))
			base.OnDragOver();
	}

	/// <summary>Drag out state logic is a bit different for the button.</summary>
	protected override void OnDragOut() {
		if(isEnabled && (dragHighlight || UICamera.currentTouch.pressed == gameObject))
			base.OnDragOut();
	}

	/// <summary>Call the listener function.</summary>
	...
	/// <summary>Convenience function that changes the sprite.</summary>
