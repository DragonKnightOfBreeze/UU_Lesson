...
/// <summary>Attaching this script to a widget makes it react to key events such as tab, up, down, etc.</summary>
[AddComponentMenu("NGUI/Interaction/Key Navigation")]
public class UIKeyNavigation : MonoBehaviour {
	/// <summary>List of all the active UINavigation components.</summary>
	...
	///     'None' means free movement on both horizontal and vertical axis. 'Explicit' means the automatic logic will not
	///     execute, and only the explicitly set values will be used.
	/// </summary>
	public Constraint constraint = Constraint.None;

	/// <summary>Which object will be selected when the Up button is pressed.</summary>
	public GameObject onUp;

	/// <summary>Which object will be selected when the Down button is pressed.</summary>
	public GameObject onDown;

	/// <summary>Which object will be selected when the Left button is pressed.</summary>
	public GameObject onLeft;

	/// <summary>Which object will be selected when the Right button is pressed.</summary>
	public GameObject onRight;

	/// <summary>Which object will get selected on click.</summary>
	public GameObject onClick;

	/// <summary>Which object will get selected on tab.</summary>
	public GameObject onTab;

	/// <summary>Whether the object this script is attached to will get selected as soon as this script is enabled.</summary>
	public bool startsSelected;

	/// <summary>Convenience function that returns the current key navigation selection.</summary>

	public static UIKeyNavigation current {
		get {
			var go = UICamera.hoveredObject;
	...
	public GameObject Get(Vector3 myDir, float x = 1f, float y = 1f) {
		...
		var myCenter = GetCenter(gameObject);
		...
		for(var i = 0; i < list.size; ++i) {
			...
			var dot = Vector3.Dot(myDir, dir.normalized);
	...
	/// <summary>React to navigation.</summary>
	...
	/// <summary>React to any additional keys, such as Tab.</summary>
