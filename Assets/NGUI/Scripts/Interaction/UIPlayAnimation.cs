...
/// <summary>Play the specified animation on click.</summary>
[ExecuteInEditMode]
[AddComponentMenu("NGUI/Interaction/Play Animation")]
public class UIPlayAnimation : MonoBehaviour {
	public static UIPlayAnimation current;

	/// <summary>Target animation to activate.</summary>
	public Animation target;

	/// <summary>Target animator system.</summary>
	public Animator animator;

	/// <summary>Optional clip name, if the animation has more than one clip.</summary>
	public string clipName;

	/// <summary>Which event will trigger the animation.</summary>
	public Trigger trigger = Trigger.OnClick;

	/// <summary>Which direction to animate in.</summary>
	public Direction playDirection = Direction.Forward;

	/// <summary>Whether the animation's position will be reset on play or will continue from where it left off.</summary>
	public bool resetOnPlay;

	/// <summary>Whether the selected object (this button) will be cleared when the animation gets activated.</summary>
	public bool clearSelection;

	/// <summary>What to do if the target game object is currently disabled.</summary>
	public EnableCondition ifDisabledOnPlay = EnableCondition.DoNothing;

	/// <summary>What to do with the target when the animation finishes.</summary>
	...
	/// <summary>Automatically find the necessary components.</summary>
	private void Start() {
		mStarted = true;
	...
	/// <summary>Start playing the animation.</summary>
	...
	public void Play(bool forward, bool onlyIfDifferent) {
		if(target || animator) {
			...
			var anim = target ? ActiveAnimation.Play(target, clipName, dir, ifDisabledOnPlay, disableWhenFinished) : ActiveAnimation.Play(animator, clipName, dir, ifDisabledOnPlay, disableWhenFinished);

			if(anim != null) {
				if(resetOnPlay) anim.Reset();
				for(var i = 0; i < onFinished.Count; ++i)
	...
	/// <summary>Callback triggered when each tween executed by this script finishes.</summary>
