...
/// <summary>
///     All children added to the game object with this script will be repositioned to be on a grid of specified
///     dimensions. If you want the cells to automatically set their scale based on the dimensions of their content, take a
///     look at UITable.
/// </summary>
...
public class UIGrid : UIWidgetContainer {
	...
	/// <summary>Type of arrangement -- vertical, horizontal or cell snap.</summary>
	public Arrangement arrangement = Arrangement.Horizontal;

	/// <summary>How to sort the grid's elements.</summary>
	public Sorting sorting = Sorting.None;

	/// <summary>Final pivot point for the grid's content.</summary>
	public UIWidget.Pivot pivot = UIWidget.Pivot.TopLeft;

	/// <summary>
	///     Maximum children per line. If the arrangement is horizontal, this denotes the number of columns. If the
	///     arrangement is vertical, this stands for the number of rows.
	/// </summary>
	public int maxPerLine;

	/// <summary>The width of each of the cells.</summary>
	public float cellWidth = 200f;

	/// <summary>The height of each of the cells.</summary>
	public float cellHeight = 200f;

	/// <summary>Whether the grid will smoothly animate its children into the correct place.</summary>
	public bool animateSmoothly;

	/// <summary>Whether to ignore the disabled children or to treat them as being present.</summary>
	public bool hideInactive;

	/// <summary>Whether the parent container will be notified of the grid's changes.</summary>
	public bool keepWithinPanel;

	/// <summary>Callback triggered when the grid repositions its contents.</summary>
	public OnReposition onReposition;

	/// <summary>Custom sort delegate, used when the sorting method is set to 'custom'.</summary>
	...
	/// <summary>Reposition the children on the next Update().</summary>
	...
	/// <summary>Get the current list of the grid's children.</summary>
	...
	/// <summary>
	///     Convenience method: get the child at the specified index. Note that if you plan on calling this function more
	///     than once, it's faster to get the entire list using GetChildList() instead.
	/// </summary>
	...
	/// <summary>Get the index of the specified item.</summary>
	public int GetIndex(Transform trans) {
		return GetChildList().IndexOf(trans);
	}

	/// <summary>Convenience method -- add a new child.</summary>
	...
	/// <summary>
	///     Convenience method -- add a new child. Note that if you plan on adding multiple objects, it's faster to
	///     GetChildList() and modify that instead.
	/// </summary>
	[System.Obsolete("Use gameObject.AddChild or transform.parent = gridTransform")]
	...
	/// <summary>
	///     Remove the specified child from the list. Note that if you plan on removing multiple objects, it's faster to
	///     GetChildList() and modify that instead.
	/// </summary>
	...
	/// <summary>Initialize the grid. Executed only once.</summary>
	protected virtual void Init() {
		mInitDone = true;
		mPanel = NGUITools.FindInParents<UIPanel>(gameObject);
	}

	/// <summary>Cache everything and reset the initial position of all children.</summary>
	protected virtual void Start() {
		if(!mInitDone) Init();
		var smooth = animateSmoothly;
	...
	/// <summary>Reset the position if necessary, then disable the component.</summary>
	protected virtual void Update() {
		Reposition();
		enabled = false;
	}

	/// <summary>Reposition the content on inspector validation.</summary>
	...
	/// <summary>You can override this function, but in most cases it's easier to just set the onCustomSort delegate instead.</summary>
	protected virtual void Sort(List<Transform> list) { }

	/// <summary>Recalculate the position of all elements within the grid, sorting them alphabetically if necessary.</summary>
	[ContextMenu("Execute")]
	...
	/// <summary>Constrain the grid's content to be within the panel's bounds.</summary>
	...
	/// <summary>Reset the position of all child objects based on the order of items in the list.</summary>
