...
/// <summary>Simple example script of how a button can be colored when the mouse hovers over it or it gets pressed.</summary>
[ExecuteInEditMode]
...
public class UIButtonColor : UIWidgetContainer {
	...
	/// <summary>Target with a widget, renderer, or light that will have its color tweened.</summary>
	public GameObject tweenTarget;

	/// <summary>Color to apply on hover event (mouse only).</summary>
	public Color hover = new Color(225f / 255f, 200f / 255f, 150f / 255f, 1f);

	/// <summary>Color to apply on the pressed event.</summary>
	public Color pressed = new Color(183f / 255f, 163f / 255f, 123f / 255f, 1f);

	/// <summary>Color that will be applied when the button is disabled.</summary>
	public Color disabledColor = Color.grey;

	/// <summary>Duration of the tween process.</summary>
	...
	/// <summary>Button's current state.</summary>
	...
	/// <summary>UIButtonColor's default (starting) color. It's useful to be able to change it, just in case.</summary>
	...
	/// <summary>Whether the script should be active or not.</summary>
	...
	/// <summary>Reset the default color to what the button started with.</summary>
	public void ResetDefaultColor() {
		defaultColor = mStartingColor;
	}

	/// <summary>Cache the default color -- should only happen once.</summary>
...
#else
			var ren = tweenTarget.GetComponent<Renderer>();
#endif
			if(ren != null) {
...
#else
				var lt = tweenTarget.GetComponent<Light>();
#endif
				if(lt != null) {
	...
	/// <summary>Set the initial state.</summary>
	...
	/// <summary>Reset the initial state.</summary>
	...
	/// <summary>Set the hover state.</summary>
	...
	/// <summary>Set the pressed state.</summary>
	...
	/// <summary>Set the pressed state on drag over.</summary>
	...
	/// <summary>Set the normal state on drag out.</summary>
	...
	/// <summary>Update the button's color. Call this method after changing the colors of the button at run-time.</summary>
	public void UpdateColor(bool instant) {
		...
		if(tweenTarget != null) {
			switch(mState) {
				case State.Hover:
					tc = TweenColor.Begin(tweenTarget, duration, hover);
					break;
				case State.Pressed:
					tc = TweenColor.Begin(tweenTarget, duration, pressed);
					break;
				case State.Disabled:
					tc = TweenColor.Begin(tweenTarget, duration, disabledColor);
					break;
				default:
					tc = TweenColor.Begin(tweenTarget, duration, mDefaultColor);
					break;
			}
