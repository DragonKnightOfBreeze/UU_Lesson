...
/// <summary>
///     Works together with UIDragCamera script, allowing you to drag a secondary camera while keeping it constrained
///     to a certain area.
/// </summary>
[RequireComponent(typeof(Camera))]
[AddComponentMenu("NGUI/Interaction/Draggable Camera")]
public class UIDraggableCamera : MonoBehaviour {
	/// <summary>Root object that will be used for drag-limiting bounds.</summary>
	...
	/// <summary>Cache the root.</summary>
	private void Start() {
	...
	private Vector3 CalculateConstrainOffset() {
		...
		var bottomLeft = new Vector3(mCam.rect.xMin * Screen.width, mCam.rect.yMin * Screen.height, 0f);
		var topRight = new Vector3(mCam.rect.xMax * Screen.width, mCam.rect.yMax * Screen.height, 0f);
	...
	/// <summary>Constrain the current camera's position to be within the viewable area's bounds.</summary>
	...
	/// <summary>Calculate the bounds of all widgets under this game object.</summary>
	...
	/// <summary>Drag event receiver.</summary>
