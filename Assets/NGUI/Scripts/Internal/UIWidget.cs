...
/// <summary>Base class for all UI components that should be derived from when creating new widget types.</summary>
[ExecuteInEditMode]
...
public class UIWidget : UIRect {
	...
	/// <summary>Notification triggered when the widget's dimensions or position changes.</summary>
	public OnDimensionsChanged onChange;

	public delegate void OnDimensionsChanged();

	/// <summary>Notification triggered after the widget's buffer has been filled.</summary>
	...
	/// <summary>
	///     Callback triggered when the widget is about to be renderered (OnWillRenderObject). NOTE: This property is only
	///     exposed for the sake of speed to avoid property execution. In most cases you will want to use UIWidget.onRender
	///     instead.
	/// </summary>
	public UIDrawCall.OnRenderCallback mOnRender;

	/// <summary>
	///     Set the callback that will be triggered when the widget is being rendered (OnWillRenderObject). This is where
	///     you would set material properties and shader values.
	/// </summary>
	...
	/// <summary>
	///     If set to 'true', the box collider's dimensions will be adjusted to always match the widget whenever it
	///     resizes.
	/// </summary>
	public bool autoResizeBoxCollider;

	/// <summary>Hide the widget if it happens to be off-screen.</summary>
	...
	/// <summary>Whether the rectangle will attempt to maintain a specific aspect ratio.</summary>
	public AspectRatioSource keepAspectRatio = AspectRatioSource.Free;

	/// <summary>If you want the anchored rectangle to keep a specific aspect ratio, set this value.</summary>
	public float aspectRatio = 1f;

	public delegate bool HitCheck(Vector3 worldPos);

	/// <summary>
	///     Custom hit check function. If set, all hit checks (including events) will call this function, passing the
	///     world position. Return 'true' if it's within the bounds of your choice, 'false' otherwise.
	/// </summary>
	public HitCheck hitCheck;

	/// <summary>Panel that's managing this widget.</summary>
	[System.NonSerialized]
	public UIPanel panel;

	/// <summary>Widget's generated geometry.</summary>
	[System.NonSerialized]
	public UIGeometry geometry = new UIGeometry();

	/// <summary>
	///     If set to 'false', the widget's OnFill function will not be called, letting you define custom geometry at
	///     will.
	/// </summary>
	[System.NonSerialized]
	...
	/// <summary>Internal usage -- draw call that's drawing the widget.</summary>
	[System.NonSerialized]
	...
	/// <summary>
	///     Draw region alters how the widget looks without modifying the widget's rectangle. A region is made up of 4
	///     relative values (0-1 range). The order is Left (X), Bottom (Y), Right (Z) and Top (W). To have a widget's left edge
	///     be 30% from the left side, set X to 0.3. To have the widget's right edge be 30% from the right hand side, set Z to
	///     0.7.
	/// </summary>
	...
	/// <summary>Pivot offset in relative coordinates. Bottom-left is (0, 0). Top-right is (1, 1).</summary>

	public Vector2 pivotOffset => NGUIMath.GetPivotOffset(pivot);

	/// <summary>Widget's width in pixels.</summary>
	...
	/// <summary>Widget's height in pixels.</summary>
	...
	/// <summary>Color used by the widget.</summary>

	public Color color {
		get { return mColor; }
		set {
			if(mColor != value) {
				var alphaChange = mColor.a != value.a;
				mColor = value;
	...
	/// <summary>Widget's alpha -- a convenience method.</summary>
	...
	/// <summary>Whether the widget is currently visible.</summary>

	public bool isVisible => mIsVisibleByPanel && mIsVisibleByAlpha && mIsInFront && finalAlpha > 0.001f && NGUITools.GetActive(this);

	/// <summary>Whether the widget has vertices to draw.</summary>

	public bool hasVertices => geometry != null && geometry.hasVertices;

	/// <summary>Change the pivot point and do not attempt to keep the widget in the same place by adjusting its transform.</summary>
	...
	/// <summary>Set or get the value that specifies where the widget's pivot point should be.</summary>

	public Pivot pivot {
		get { return mPivot; }
		set {
			if(mPivot != value) {
				var before = worldCorners[0];

				mPivot = value;
				mChanged = true;

				var after = worldCorners[0];
	...
	/// <summary>Depth controls the rendering order -- lowest to highest.</summary>
	...
	/// <summary>
	///     Raycast depth order on widgets takes the depth of their panel into consideration. This functionality is used
	///     to determine the "final" depth of the widget for drawing and raycasts.
	/// </summary>
	...
	/// <summary>Local space corners of the widget. The order is bottom-left, top-left, top-right, bottom-right.</summary>
	...
	/// <summary>Local width and height of the widget in pixels.</summary>
	...
	/// <summary>Widget's center in local coordinates. Don't forget to transform by the widget's transform.</summary>
	...
	/// <summary>World-space corners of the widget. The order is bottom-left, top-left, top-right, bottom-right.</summary>
	...
	/// <summary>World-space center of the widget.</summary>

	public Vector3 worldCenter => cachedTransform.TransformPoint(localCenter);

	/// <summary>Local space region where the actual drawing will take place. X = left, Y = bottom, Z = right, W = top.</summary>
	...
	/// <summary>Custom material associated with the widget, if any.</summary>
	...
	/// <summary>Texture used by the widget.</summary>
	...
	/// <summary>Shader is used to create a dynamic material if the widget has no material to work with.</summary>
	...
	/// <summary>Do not use this, it's obsolete.</summary>

	[System.Obsolete("There is no relative scale anymore. Widgets now have width and height instead")]
	public Vector2 relativeSize => Vector2.one;

	/// <summary>Convenience function that returns 'true' if the widget has a box collider.</summary>
	...
	/// <summary>Adjust the widget's dimensions without going through the anchor validation logic.</summary>
	...
	/// <summary>Force-calculate the final alpha value.</summary>
	...
	/// <summary>Update the widget's visibility and final alpha.</summary>
	public override void Invalidate(bool includeChildren) {
		mChanged = true;
		mAlphaFrameID = -1;

		if(panel != null) {
			var vis = hideIfOffScreen || panel.hasCumulativeClipping ? panel.IsVisible(this) : true;
	...
	/// <summary>Same as final alpha, except it doesn't take own visibility into consideration. Used by panels.</summary>
	public float CalculateCumulativeAlpha(int frameID) {
		var pt = parent;
		return pt != null ? pt.CalculateFinalAlpha(frameID) * mColor.a : mColor.a;
	}

	/// <summary>Set the widget's rectangle. XY is the bottom-left corner.</summary>
	...
	/// <summary>Adjust the widget's collider size to match the widget's dimensions.</summary>
	public void ResizeCollider() {
		if(NGUITools.GetActive(this)) NGUITools.UpdateWidgetCollider(gameObject);
	}

	/// <summary>Static widget comparison function used for depth sorting.</summary>
	[System.Diagnostics.DebuggerHidden]
	[System.Diagnostics.DebuggerStepThrough]
	public static int FullCompareFunc(UIWidget left, UIWidget right) {
		var val = UIPanel.CompareFunc(left.panel, right.panel);
		return val == 0 ? PanelCompareFunc(left, right) : val;
	}

	/// <summary>Static widget comparison function used for inter-panel depth sorting.</summary>
	[System.Diagnostics.DebuggerHidden]
	[System.Diagnostics.DebuggerStepThrough]
	public static int PanelCompareFunc(UIWidget left, UIWidget right) {
		...
		var leftMat = left.material;
		var rightMat = right.material;
	...
	/// <summary>Calculate the widget's bounds, optionally making them relative to the specified transform.</summary>
	...
	public Bounds CalculateBounds(Transform relativeParent) {
		if(relativeParent == null) {
			...
			for(var j = 1; j < 4; ++j) b.Encapsulate(corners[j]);
			return b;
		}
		else {
			var toLocal = relativeParent.worldToLocalMatrix;
			var corners = worldCorners;
			var b = new Bounds(toLocal.MultiplyPoint3x4(corners[0]), Vector3.zero);
			for(var j = 1; j < 4; ++j) b.Encapsulate(toLocal.MultiplyPoint3x4(corners[j]));
			return b;
		}
	}

	/// <summary>Mark the widget as changed so that the geometry can be rebuilt.</summary>
	...
	/// <summary>Remove this widget from the panel.</summary>
...
#if UNITY_EDITOR
	[System.NonSerialized]
	private Texture mOldTex;
	[System.NonSerialized]
	private Shader mOldShader;

	/// <summary>This callback is sent inside the editor notifying us that some property has changed.</summary>
	protected override void OnValidate() {
		if(NGUITools.GetActive(this)) {
			...
			aspectRatio = keepAspectRatio == AspectRatioSource.Free ? (float) mWidth / mHeight : Mathf.Max(0.01f, aspectRatio);
	...
	/// <summary>Tell the panel responsible for the widget that something has changed and the buffers need to be rebuilt.</summary>
	...
	/// <summary>Ensure we have a panel referencing this widget.</summary>
	...
	/// <summary>Check to ensure that the widget resides on the same layer as its panel.</summary>
	...
	/// <summary>Checks to ensure that the widget is still parented to the right panel.</summary>
	public override void ParentHasChanged() {
		base.ParentHasChanged();

		if(panel != null) {
			var p = UIPanel.Find(cachedTransform, true, cachedGameObject.layer);
	...
	/// <summary>Remember whether we're in play mode.</summary>
	protected override void Awake() {
		base.Awake();
		mPlayMode = Application.isPlaying;
	}

	/// <summary>Mark the widget and the panel as having been changed.</summary>
	...
	/// <summary>Facilitates upgrading from NGUI 2.6.5 or earlier versions.</summary>
	...
	/// <summary>Virtual Start() functionality for widgets.</summary>
	...
	/// <summary>Update the anchored edges and ensure the widget is registered with a panel.</summary>
	...
	/// <summary>Ensure we have a panel to work with.</summary>
...
/// </summary>
	...
	/// <summary>Clear references.</summary>
	protected override void OnDisable() {
		RemoveFromPanel();
		base.OnDisable();
	}

	/// <summary>Unregister this widget.</summary>
	private void OnDestroy() {
		RemoveFromPanel();
	}

#if UNITY_EDITOR
	private static int mHandles = -1;

	/// <summary>Whether widgets will show handles with the Move Tool, or just the View Tool.</summary>
	...
	/// <summary>Whether the widget should have some form of handles shown.</summary>
	...
	/// <summary>Draw some selectable gizmos.</summary>
	private void OnDrawGizmos() {
		if(isVisible && NGUITools.GetActive(this)) {
			if(UnityEditor.Selection.activeGameObject == gameObject && showHandles) return;

			var outline = new Color(1f, 1f, 1f, 0.2f);

			var adjustment = root != null ? 0.05f : 0.001f;
			var offset = pivotOffset;
			var center = new Vector3(mWidth * (0.5f - offset.x), mHeight * (0.5f - offset.y), -mDepth * adjustment);
			var size = new Vector3(mWidth, mHeight, 1f);
	...
	/// <summary>Update the widget's visibility state.</summary>
	...
	/// <summary>Check to see if the widget has moved relative to the panel that manages it</summary>
	public bool UpdateTransform(int frame) {
...
#endif 
		{
			...
			var v0 = panel.worldToLocal.MultiplyPoint3x4(trans.TransformPoint(x0, y0, 0f));
			var v1 = panel.worldToLocal.MultiplyPoint3x4(trans.TransformPoint(x1, y1, 0f));
	...
	/// <summary>Update the widget and fill its geometry if necessary. Returns whether something was changed.</summary>
	public bool UpdateGeometry(int frame) {
		// Has the alpha changed?
		var finalAlpha = CalculateFinalAlpha(frame);
		...
		if(mChanged) {
			if(mIsVisibleByAlpha && finalAlpha > 0.001f && shader != null) {
				var hadVertices = geometry.hasVertices;
	...
	/// <summary>Append the local geometry buffers to the specified ones.</summary>
	...
	/// <summary>Make the widget pixel-perfect.</summary>
	public virtual void MakePixelPerfect() {
		...
		var ls = cachedTransform.localScale;
	...
	/// <summary>Dimensions of the sprite's border, if any.</summary>
