...
/// <summary>Glyph structure used by BMFont. For more information see http://www.angelcode.com/products/bmfont/</summary>
[System.Serializable]
public class BMGlyph {
	...
	/// <summary>Retrieves the special amount by which to adjust the cursor position, given the specified previous character.</summary>
	...
	/// <summary>Add a new kerning entry to the character (or adjust an existing one).</summary>
	...
	/// <summary>Trim the glyph, given the specified minimum and maximum dimensions in pixels.</summary>
