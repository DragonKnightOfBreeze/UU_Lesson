...
/// <summary>Reference to a specific field or property that can be set via inspector.</summary>
[Serializable]
public class PropertyReference {
	...
	/// <summary>Helper function that returns the property type.</summary>
	...
	public override bool Equals(object obj) {
		...
		if(obj is PropertyReference) {
			var pb = obj as PropertyReference;
	...
	/// <summary>Reset the cached references.</summary>
	public void Reset() {
#if REFLECTION_SUPPORT
		mField = null;
		mProperty = null;
	...
	/// <summary>Convenience function that converts the specified component + property pair into its string representation.</summary>
...
#if REFLECTION_SUPPORT
	/// <summary>Retrieve the property's value.</summary>
	[DebuggerHidden]
	[DebuggerStepThrough]
	public object Get() {
		if(mProperty == null && mField == null && isValid) Cache();
	...
	/// <summary>Assign the bound property's value.</summary>
	[DebuggerHidden]
	[DebuggerStepThrough]
	...
	/// <summary>Cache the field or property.</summary>
	[DebuggerHidden]
	[DebuggerStepThrough]
	private bool Cache() {
	...
	/// <summary>Whether we can assign the property using the specified value.</summary>
	...
	/// <summary>Whether we can convert one type to another for assignment purposes.</summary>
