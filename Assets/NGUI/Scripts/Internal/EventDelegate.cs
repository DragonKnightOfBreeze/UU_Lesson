...
/// <summary>Delegate callback that Unity can serialize and set via Inspector.</summary>
[System.Serializable]
public class EventDelegate {
	/// <summary>
	///     Delegates can have parameters, and this class makes it possible to save references to properties that can then
	///     be passed as function arguments, such as transform.position or widget.color.
	/// </summary>
	[System.Serializable]
	public class Parameter {
		...
		/// <summary>Return the property's current value.</summary>
		...
		/// <summary>Parameter type -- a convenience function.</summary>
	...
	/// <summary>Whether the event delegate will be removed after execution.</summary>
	public bool oneShot;
	...
	/// <summary>Event delegate's target object.</summary>
	...
	/// <summary>Event delegate's method name.</summary>
	...
	/// <summary>Optional parameters if the method requires them.</summary>
	...
	/// <summary>Whether this delegate's values have been set.</summary>
	...
	/// <summary>Whether the target script is actually enabled.</summary>
	...
	/// <summary>GetMethodName is not supported on some platforms.</summary>
#if REFLECTION_SUPPORT
	...
	private static readonly int s_Hash = "EventDelegate".GetHashCode();

	/// <summary>Used in equality operators.</summary>
	public override int GetHashCode() {
		return s_Hash;
	}

	/// <summary>Set the delegate callback directly.</summary>
	...
	/// <summary>Set the delegate callback using the target and method names.</summary>
	...
	/// <summary>Cache the callback and create the list of the necessary parameters.</summary>
	private void Cache() {
		mCached = true;
...
// For some odd reason Type.GetMethod(name, bindingFlags) doesn't seem to work on WP8...
	...
	/// <summary>
	///     Execute the delegate, if possible. This will only be used when the application is playing in order to prevent
	...
	public bool Execute() {
		...
		if(mCachedCallback != null) {
			...
			if(Application.isPlaying) {
				...
				var type = mCachedCallback.Target.GetType();
...
// #endif
...
#endif
			var len = mParameters != null ? mParameters.Length : 0;
			...
			if(len == 0) {
				...
				try {
					...
					if(mParameterInfos.Length == 0) {
						...
						for(var i = 1; i < mParameterInfos.Length; ++i)
					...
					if(mParameters.Length == 0) {
						...
						for(var i = 1; i < mParameters.Length; ++i)
	...
	/// <summary>Clear the event delegate.</summary>
	public void Clear() {
		mTarget = null;
		mMethodName = null;
		mRawDelegate = false;
	...
	/// <summary>Convert the delegate to its string representation.</summary>
	public override string ToString() {
		if(mTarget != null) {
			var typeName = mTarget.GetType().ToString();
	...
	/// <summary>Execute an entire list of delegates.</summary>
	...
	/// <summary>Convenience function to check if the specified list of delegates can be executed.</summary>
	...
	/// <summary>Assign a new event delegate.</summary>
	...
	/// <summary>Append a new event delegate to the list.</summary>
	...
	public static void Add(List<EventDelegate> list, EventDelegate ev, bool oneShot) {
		if(ev.mRawDelegate || ev.target == null || string.IsNullOrEmpty(ev.methodName)) {
			...
			if(ev.mParameters != null && ev.mParameters.Length > 0) {
				...
				for(var i = 0; i < ev.mParameters.Length; ++i)
	...
	/// <summary>Remove an existing event delegate from the list.</summary>
