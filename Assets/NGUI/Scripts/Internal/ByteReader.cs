...
/// <summary>
///     MemoryStream.ReadLine has an interesting oddity: it doesn't always advance the stream's position by the
///     correct amount:
///     http://social.msdn.microsoft.com/Forums/en-AU/Vsexpressvcs/thread/b8f7837b-e396-494e-88e1-30547fcf385f Solution?
///     Custom line reader with the added benefit of not having to use streams at all.
/// </summary>
public class ByteReader {
	...
	/// <summary>Read the contents of the specified file and return a Byte Reader to work with.</summary>
	...
	/// <summary>Whether the buffer is readable.</summary>

	public bool canRead => mBuffer != null && mOffset < mBuffer.Length;

	/// <summary>Read a single line from the buffer.</summary>
...
// Encoding.UTF8 is not supported in Flash :(
	...
	/// <summary>Assume that the entire file is a collection of key/value pairs.</summary>
	...
	private static readonly BetterList<string> mTemp = new BetterList<string>();

	/// <summary>Read a single line of Comma-Separated Values from the file.</summary>
