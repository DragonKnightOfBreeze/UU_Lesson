...
/// <summary>
///     Localization manager is able to parse localization information from text assets. Using it is simple: text =
///     Localization.Get(key), or just add a UILocalize script to your labels. You can switch the language by using
///     Localization.language = "French", for example. This will attempt to load the file called "French.txt" in the
///     Resources folder, or a column "French" from the Localization.csv file in the Resources folder. If going down the
///     TXT language file route, it's expected that the file is full of key = value pairs, like so: LABEL1 = Hello LABEL2 =
///     Music Info = Localization Example In the case of the CSV file, the first column should be the "KEY". Other columns
///     should be your localized text values, such as "French" for the first row: KEY,English,French LABEL1,Hello,Bonjour
///     LABEL2,Music,Musique Info,"Localization Example","Par exemple la localisation"
/// </summary>
public static class Localization {
	...
	/// <summary>Want to have Localization loading be custom instead of just Resources.Load? Set this function.</summary>
	public static LoadFunction loadFunction;

	/// <summary>
	///     Notification triggered when the localization data gets changed, such as when changing the language. If you
	///     want to make modifications to the localization data after it was loaded, this is the place.
	/// </summary>
	public static OnLocalizeNotification onLocalize;

	/// <summary>Whether the localization dictionary has been loaded.</summary>
	...
	/// <summary>
	///     Localization dictionary. Dictionary key is the localization key. Dictionary value is the list of localized
	///     values (columns in the CSV file).
	/// </summary>
	...
	/// <summary>List of loaded languages. Available if a single Localization.csv file was used.</summary>
	...
	/// <summary>Name of the currently active language.</summary>
	...
	/// <summary>Load the specified language.</summary>
	...
	/// <summary>Load the specified asset and activate the localization.</summary>
	public static void Load(TextAsset asset) {
		var reader = new ByteReader(asset);
		Set(asset.name, reader.ReadDictionary());
	}

	/// <summary>Set the localization data directly.</summary>
	public static void Set(string languageName, byte[] bytes) {
		var reader = new ByteReader(bytes);
		Set(languageName, reader.ReadDictionary());
	}

	/// <summary>Forcefully replace the specified key with another value.</summary>
	...
	/// <summary>Clear the replacement values.</summary>
	public static void ClearReplacements() {
		mReplacement.Clear();
	}

	/// <summary>Load the specified CSV file.</summary>
	...
	/// <summary>Whether the specified language is present in the localization.</summary>
	...
	private static bool LoadCSV(byte[] bytes, TextAsset asset, bool merge = false) {
		...
		if(!localizationHasBeenSet || !merge && !mMerging || mLanguages == null || mLanguages.Length == 0) {
			...
			for(var i = 0; i < header.size; ++i) languagesToAdd[i] = header[i];
	...
	/// <summary>Helper function that adds a single line from a CSV file to the localization list.</summary>
	...
	/// <summary>Used to merge separate localization files into one.</summary>
	...
	/// <summary>Select the specified language from the previously loaded CSV file.</summary>
	...
	/// <summary>
	///     Change or set the localization value for the specified key. Note that this method only supports one fallback
	///     language, and should ideally be called from within Localization.onLocalize. To set the multi-language value just
	///     modify Localization.dictionary directly.
	/// </summary>
	...
	/// <summary>Localize the specified value.</summary>
	...
	/// <summary>Localize the specified value and format it.</summary>
	...
	/// <summary>Returns whether the specified key is present in the localization dictionary.</summary>
