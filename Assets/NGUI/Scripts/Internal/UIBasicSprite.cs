...
/// <summary>
///     Functionality common to both NGUI and 2D sprites brought out into a single common parent. Mostly contains
///     everything related to drawing the sprite.
/// </summary>
public abstract class UIBasicSprite : UIWidget {
	...
	[HideInInspector]
	[SerializeField]
	protected Type mType = Type.Simple;
	[HideInInspector]
	[SerializeField]
	...
	/// <summary>When the sprite type is advanced, this determines whether the center is tiled or sliced.</summary>
	public AdvancedType centerType = AdvancedType.Sliced;

	/// <summary>When the sprite type is advanced, this determines whether the left edge is tiled or sliced.</summary>
	public AdvancedType leftType = AdvancedType.Sliced;

	/// <summary>When the sprite type is advanced, this determines whether the right edge is tiled or sliced.</summary>
	public AdvancedType rightType = AdvancedType.Sliced;

	/// <summary>When the sprite type is advanced, this determines whether the bottom edge is tiled or sliced.</summary>
	public AdvancedType bottomType = AdvancedType.Sliced;

	/// <summary>When the sprite type is advanced, this determines whether the top edge is tiled or sliced.</summary>
	public AdvancedType topType = AdvancedType.Sliced;

	/// <summary>How the sprite is drawn. It's virtual for legacy reasons (UISlicedSprite, UITiledSprite, UIFilledSprite).</summary>
	...
	/// <summary>Sprite flip setting.</summary>
	...
	/// <summary>Direction of the cut procedure.</summary>
	...
	/// <summary>Amount of the sprite shown. 0-1 range with 0 being nothing shown, and 1 being the full sprite.</summary>
	...
	/// <summary>Whether the sprite should be filled in the opposite direction.</summary>
	...
	/// <summary>Whether the widget has a border for 9-slicing.</summary>
	...
	/// <summary>Whether the sprite's material is using a pre-multiplied alpha shader.</summary>

	public virtual bool premultipliedAlpha => false;

	/// <summary>Size of the pixel. Overwritten in the NGUI sprite to pull a value from the atlas.</summary>

	public virtual float pixelSize => 1f;

#if UNITY_EDITOR
	/// <summary>Keep sane values.</summary>
	...
	/// <summary>
	///     Convenience function that returns the drawn UVs after flipping gets considered. X = left, Y = bottom, Z =
	///     right, W = top.
	/// </summary>
	...
	/// <summary>Final widget's color passed to the draw buffer.</summary>
	...
	/// <summary>Fill the draw buffers.</summary>
	...
	/// <summary>Regular sprite fill function is quite simple.</summary>
	...
	/// <summary>Sliced sprite fill function is more complicated as it generates 9 quads instead of 1.</summary>
	...
	/// <summary>Adds a gradient-based vertex color to the sprite.</summary>
	...
	/// <summary>Tiled sprite fill function.</summary>
		...
		if(mFillAmount < 1f) {
			...
			if(mFillDirection == FillDirection.Radial180) {
				for(var side = 0; side < 2; ++side) {
					...
					var val = !mInvert ? fillAmount * 2f - side : mFillAmount * 2f - (1 - side);
			...
			if(mFillDirection == FillDirection.Radial360) {
				for(var corner = 0; corner < 4; ++corner) {
					...
					var val = mInvert ? mFillAmount * 4f - NGUIMath.RepeatIndex(corner + 2, 4) : mFillAmount * 4f - (3 - NGUIMath.RepeatIndex(corner + 2, 4));
	...
	/// <summary>Advanced sprite fill function. Contributed by Nicki Hansen.</summary>
			...
			for(var y = 0; y < 3; ++y) {
				...
				if(x == 1 && y == 1) // Center
				{
					if(centerType == AdvancedType.Tiled) {
						var startPositionX = mTempPos[x].x;
						var endPositionX = mTempPos[x2].x;
						var startPositionY = mTempPos[y].y;
						var endPositionY = mTempPos[y2].y;
						var textureStartX = mTempUVs[x].x;
						var textureStartY = mTempUVs[y].y;
						var tileStartY = startPositionY;

						while(tileStartY < endPositionY) {
							var tileStartX = startPositionX;
							var textureEndY = mTempUVs[y2].y;
							var tileEndY = tileStartY + tileSize.y;
							...
							while(tileStartX < endPositionX) {
								var tileEndX = tileStartX + tileSize.x;
								var textureEndX = mTempUVs[x2].x;
	...
	/// <summary>Adjust the specified quad, making it be radially filled instead.</summary>
	...
	/// <summary>Helper function that adds the specified values to the buffers.</summary>
	private static void Fill(List<Vector3> verts, List<Vector2> uvs, List<Color> cols,
