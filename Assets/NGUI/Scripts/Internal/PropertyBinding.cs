...
/// <summary>Property binding lets you bind two fields or properties so that changing one will update the other.</summary>
[ExecuteInEditMode]
...
public class PropertyBinding : MonoBehaviour {
	...
	/// <summary>First property reference.</summary>
	public PropertyReference source;

	/// <summary>Second property reference.</summary>
	public PropertyReference target;

	/// <summary>Direction of updates.</summary>
	public Direction direction = Direction.SourceUpdatesTarget;

	/// <summary>When the property update will occur.</summary>
	public UpdateCondition update = UpdateCondition.OnUpdate;

	/// <summary>Whether the values will update while in edit mode.</summary>
	...
	/// <summary>Immediately update the bound data.</summary>
