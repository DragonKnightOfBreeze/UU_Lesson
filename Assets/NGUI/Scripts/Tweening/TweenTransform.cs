...
/// <summary>Tween the object's position, rotation and scale.</summary>
...
public class TweenTransform : UITweener {
	...
	/// <summary>Interpolate the position, scale, and rotation.</summary>
	...
	/// <summary>Start the tweening operation from the current position/rotation/scale to the target transform.</summary>
	...
	public static TweenTransform Begin(GameObject go, float duration, Transform from, Transform to) {
		var comp = UITweener.Begin<TweenTransform>(go, duration);
		comp.from = from;
		comp.to = to;
