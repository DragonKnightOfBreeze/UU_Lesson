...
/// <summary>Tween the audio source's volume.</summary>
...
public class TweenVolume : UITweener {
	...
	/// <summary>Cached version of 'audio', as it's always faster to cache.</summary>
	...
	/// <summary>Audio source's current volume.</summary>
	...
	public static TweenVolume Begin(GameObject go, float duration, float targetVolume) {
		var comp = UITweener.Begin<TweenVolume>(go, duration);
