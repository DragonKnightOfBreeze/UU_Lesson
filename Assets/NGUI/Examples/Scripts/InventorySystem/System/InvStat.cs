/// <summary>Inventory System statistic</summary>
[System.Serializable]
public class InvStat {
	/// <summary>Customize this enum with statistics appropriate for your own game</summary>
	...
	/// <summary>Formula for final stats: [sum of raw amounts] * (1 + [sum of percent amounts])</summary>
	...
	/// <summary>Get the localized name of the stat.</summary>
	public static string GetName(Identifier i) {
		return i.ToString();
	}

	/// <summary>Get the localized stat's description -- adjust this to fit your own stats.</summary>
	...
	/// <summary>Comparison function for sorting armor. Armor value will show up first, followed by damage.</summary>
	...
	/// <summary>Comparison function for sorting weapons. Damage value will show up first, followed by armor.</summary>
