...
/// <summary>Want something to spin? Attach this script to it. Works equally well with rigidbodies as without.</summary>
...
public class Spin : MonoBehaviour {
	...
	public void ApplyDelta(float delta) {
		...
		var offset = Quaternion.Euler(rotationsPerSecond * delta);
