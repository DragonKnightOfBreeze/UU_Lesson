...
/// <summary>
///     This sample demonstrates how to use the two-fingers Pinch and Rotation gesture events to control the scale and
///     orientation of a rectangle on the screen
/// </summary>
...
";
	...
	public bool RotationAllowed => inputMode == InputMode.RotationOnly || inputMode == InputMode.PinchAndRotation;
	...
	public bool PinchAllowed => inputMode == InputMode.PinchOnly || inputMode == InputMode.PinchAndRotation;
